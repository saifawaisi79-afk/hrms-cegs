...
const SEED_DATA = {
  ...
  settings:{
    ...
    hours:{start:'09:00',end:'17:00',grace:15,days:['Mon','Tue','Wed','Thu','Fri']},
    ...
    <div className="app-shell" onClick={() => setActiveDropdown(null)}>
      <header className="cegs-header" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="header-right">
          <button className="cegs-btn-setting" onClick={() => setView(isSA ? 'settings' : 'profile')}>
            <IC n="settings" s={14} />
            <span>Setting</span>
          </button>
      ...
      <div className="modern-dash-main">
        ...
        <div className="calendar-schedule-widget">
          ...
          <div className="calendar-slider-container">
            {weekdays.map((w, idx) => (
              <div key={idx} className={`cal-capsule ${activeDay === idx ? 'active' : ''}`} onClick={() => setActiveDay(idx)}>
                <span className="cal-capsule-day">{w.day.slice(0, 3)}</span>
  ...
  return (
    <div className="anim-fadeup">
      ...
      {tab==='hours'&&<Section title="Working Hours Configuration">
        <div className="form-row">
          <div className="form-group"><label className="form-label">Shift Start</label><input type="time" className="form-input" value={s.hours?.start||'09:00'} onChange={e=>setS({...s,hours:{...s.hours,start:e.target.value}})}/></div>
          <div className="form-group"><label className="form-label">Shift End</label><input type="time" className="form-input" value={s.hours?.end||'17:00'} onChange={e=>setS({...s,hours:{...s.hours,end:e.target.value}})}/></div>
        </div>
